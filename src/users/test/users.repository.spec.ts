...
describe('UsersRepository', () => {
    ...
    describe('find operations', () => {
        ...
        describe('findOneAndUpdate', () => {
            describe('when findOneAndUpdate is called', () => {
                ...
                test('then it should call the userModel', () => {
                    expect(userModel.findOneAndUpdate).toHaveBeenCalledWith(userFilterQuery, userStub(), {
                        new: true
                    });
                })
    ...
    describe('create operations', () => {
        // we need a separate module for our create operations and for a find operation
        // find vada thi alg rakhvanu  this.entityModel constructor mate
        beforeEach(async () => {
            const moduleRef = await Test.createTestingModule({
                providers: [
                    UsersRepository,
